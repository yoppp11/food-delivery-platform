...
import { ChatService } from "../src/modules/chat/chat.service.new";
...
describe("ChatService", () => {
  ...
  describe("getOrCreateChatRoom", () => {
    ...
    it("should throw error for CUSTOMER_DRIVER when driver not assigned", async () => {
      const orderWithoutDriver = { ...mockOrder, driver: null };
      ...
      ).rejects.toThrow(new HttpException("Driver not assigned", HttpStatus.BAD_REQUEST));
    });
